          ...
          <div className="container xl:max-w-7xl mx-auto px-4 lg:px-8">
            <div className="flex justify-between py-4">
              ...
              <div className="flex items-center space-x-2 lg:space-x-5">
                ...
                <nav className="hidden lg:flex items-center space-x-2">
                  <a href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-pink-600 border border-pink-100 bg-pink-50 dark:text-white dark:bg-gray-700 dark:border-transparent">
                  ...
                  <a href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-800 border border-transparent hover:text-pink-600 hover:bg-pink-50 active:border-pink-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700 dark:active:border-gray-600">
                            ...
                            {({ active }) => (
                              <a
                                ...
                                className={`group text-sm font-medium flex items-center justify-between space-x-2 px-2.5 py-2 rounded-lg border border-transparent ${
                                  active ? "text-pink-800 bg-pink-50 dark:text-white dark:bg-gray-700/75 dark:border-transparent" : "text-gray-700 hover:text-pink-800 hover:bg-pink-50 active:border-pink-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700/75 dark:active:border-gray-600"
                                }`}
                              >
                                ...
                                <div className="font-semibold inline-flex px-1.5 py-0.5 leading-4 text-xs rounded-full border border-pink-200 text-pink-700 bg-pink-100 dark:text-pink-50 dark:bg-pink-700 dark:border-pink-700">2</div>
                              </a>
                            )}
                          </Menu.Item>
                          <Menu.Item>
                            {({ active }) => (
                              ...
                              >
                                ...
                                <div className="font-semibold inline-flex px-1.5 py-0.5 leading-4 text-xs rounded-full border border-pink-200 text-pink-700 bg-pink-100 dark:text-pink-50 dark:bg-pink-700 dark:border-pink-700">5</div>
                              </a>
                            )}
                          </Menu.Item>
                        </div>
            ...
            >
              <nav className="flex flex-col space-y-2 py-4 border-t dark:border-gray-700">
                <a href="#" className="group text-sm font-semibold flex items-center space-x-2 px-3 py-2 rounded-lg text-pink-600 border border-pink-50 bg-pink-50 dark:text-white dark:bg-gray-700/75 dark:border-transparent">
                  <svg className="hi-mini hi-home inline-block w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fillRule="evenodd" d="M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z" clipRule="evenodd" /></svg>
                  <span>Dashboard</span>
                </a>
                <a href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-800 border border-transparent hover:text-pink-600 hover:bg-pink-50 active:border-pink-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700 dark:active:border-gray-600">
        ...
        <footer id="page-footer" className="flex flex-none items-center bg-white dark:bg-gray-800">
          <div className="text-center flex flex-col md:text-left md:flex-row md:justify-between text-sm container xl:max-w-7xl mx-auto px-4 lg:px-8">
            <div className="pt-4 pb-1 md:pb-4">
              <a href="https://tailkit.com" className="font-medium text-pink-600 hover:text-pink-400 dark:text-pink-400 dark:hover:text-pink-300" target="_blank">Tailkit</a> ©
            </div>
            <div className="pb-4 pt-1 md:pt-4 inline-flex items-center justify-center">
              ...
              <span> by <a href="https://pixelcave.com" className="font-medium text-pink-600 hover:text-pink-400 dark:text-pink-400 dark:hover:text-pink-300" target="_blank">pixelcave</a></span>
            </div>
          </div>
        </footer>
        {/* END Page Footer */}
