...
const HomeHeader = () => {
  ...
  const open = 'absolute flex backdrop-blur-[9px] bg-white/30 w-[70%] min-h-[100vh] top-[0px] left-0 duration-500 md:bg-inherit md:min-h-fit md:w-auto md:static'

  const close = 'absolute flex backdrop-blur-[9px] bg-white/30 w-[70%] min-h-[100vh] top-[0px] left-[-100%] left-0 duration-500 md:bg-inherit md:min-h-fit md:w-auto md:static'
  ...
  return (
    <div className=''>
      <header className='flex justify-between px-1 md:px-10 m-auto align-middle items-center top-0 left-0 w-[100%] bg-inherit'>
        ...
        <div
          //  className={`absolute flex backdrop-blur-[9px] bg-white/30 w-[70%] min-h-[100vh] top-[0px]  left-${isMenuOpen ? '' : '[-100%]'} left-0 duration-500 md:bg-inherit md:min-h-fit md:w-auto md:static`}
